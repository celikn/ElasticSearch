...
##Source: https://github.com/elastic/elasticsearch-py/blob/main/examples/bulk-ingest/bulk-ingest.py
...
def download_dataset():
    ...
    if not exists(DATASET_PATH):
        ...
        resp = http.request("GET", NYC_RESTAURANTS, preload_content=False,verify=False)
